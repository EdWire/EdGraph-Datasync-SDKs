...
namespace EdGraph.Datasync.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataSyncApi.Provider.V1.ProviderListResponse")]
    public partial class DataSyncApiProviderV1ProviderListResponse : IEquatable<DataSyncApiProviderV1ProviderListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiProviderV1ProviderListResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiProviderV1ProviderListResponse {\n");
        ...
        {
            return this.Equals(input as DataSyncApiProviderV1ProviderListResponse);
        }

        /// <summary>
        /// Returns true if DataSyncApiProviderV1ProviderListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiProviderV1ProviderListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiProviderV1ProviderListResponse input)
        {
            if (input == null)
            {
                return false;
