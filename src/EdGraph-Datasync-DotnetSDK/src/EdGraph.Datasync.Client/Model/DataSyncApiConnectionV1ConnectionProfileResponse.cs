...
namespace EdGraph.Datasync.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataSyncApi.Connection.V1.ConnectionProfileResponse")]
    public partial class DataSyncApiConnectionV1ConnectionProfileResponse : IEquatable<DataSyncApiConnectionV1ConnectionProfileResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiConnectionV1ConnectionProfileResponse" /> class.
        /// </summary>
        ...
        public DataSyncApiConnectionV1ConnectionProfileResponse(string tenantId = default(string), string connectionId = default(string), string name = default(string), string providerId = default(string), string providerName = default(string), string connectionTypeId = default(string), string connectionTypeName = default(string), string createdBy = default(string), string createdDateTime = default(string), string lastModifiedBy = default(string), string lastModifiedDateTime = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiConnectionV1ConnectionProfileResponse {\n");
        ...
        {
            return this.Equals(input as DataSyncApiConnectionV1ConnectionProfileResponse);
        }

        /// <summary>
        /// Returns true if DataSyncApiConnectionV1ConnectionProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiConnectionV1ConnectionProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiConnectionV1ConnectionProfileResponse input)
        {
            if (input == null)
            {
                return false;
