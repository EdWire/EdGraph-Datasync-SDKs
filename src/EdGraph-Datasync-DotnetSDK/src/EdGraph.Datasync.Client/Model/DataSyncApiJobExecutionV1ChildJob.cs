...
namespace EdGraph.Datasync.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataSyncApi.JobExecution.V1.ChildJob")]
    public partial class DataSyncApiJobExecutionV1ChildJob : IEquatable<DataSyncApiJobExecutionV1ChildJob>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiJobExecutionV1ChildJob" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiJobExecutionV1ChildJob {\n");
        ...
        {
            return this.Equals(input as DataSyncApiJobExecutionV1ChildJob);
        }

        /// <summary>
        /// Returns true if DataSyncApiJobExecutionV1ChildJob instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiJobExecutionV1ChildJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiJobExecutionV1ChildJob input)
        {
            if (input == null)
            {
                return false;
