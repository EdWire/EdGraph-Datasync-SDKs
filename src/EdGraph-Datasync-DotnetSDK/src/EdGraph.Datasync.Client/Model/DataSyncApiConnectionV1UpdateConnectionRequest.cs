...
{
    /// <summary>
    /// DataSyncApiConnectionV1UpdateConnectionRequest
    /// </summary>
    [DataContract(Name = "DataSyncApi.Connection.V1.UpdateConnectionRequest")]
    public partial class DataSyncApiConnectionV1UpdateConnectionRequest : IEquatable<DataSyncApiConnectionV1UpdateConnectionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiConnectionV1UpdateConnectionRequest" /> class.
        /// </summary>
        ...
        public DataSyncApiConnectionV1UpdateConnectionRequest(string tenantId = default(string), string connectionId = default(string), string name = default(string), string providerId = default(string), string connectionTypeId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiConnectionV1UpdateConnectionRequest {\n");
        ...
        {
            return this.Equals(input as DataSyncApiConnectionV1UpdateConnectionRequest);
        }

        /// <summary>
        /// Returns true if DataSyncApiConnectionV1UpdateConnectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiConnectionV1UpdateConnectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiConnectionV1UpdateConnectionRequest input)
        {
            if (input == null)
            {
                return false;
