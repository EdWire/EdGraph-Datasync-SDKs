...
namespace EdGraph.Datasync.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataSyncApi.JobType.V1.JobTypeProfileResponse")]
    public partial class DataSyncApiJobTypeV1JobTypeProfileResponse : IEquatable<DataSyncApiJobTypeV1JobTypeProfileResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiJobTypeV1JobTypeProfileResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiJobTypeV1JobTypeProfileResponse {\n");
        ...
        {
            return this.Equals(input as DataSyncApiJobTypeV1JobTypeProfileResponse);
        }

        /// <summary>
        /// Returns true if DataSyncApiJobTypeV1JobTypeProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiJobTypeV1JobTypeProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiJobTypeV1JobTypeProfileResponse input)
        {
            if (input == null)
            {
                return false;
