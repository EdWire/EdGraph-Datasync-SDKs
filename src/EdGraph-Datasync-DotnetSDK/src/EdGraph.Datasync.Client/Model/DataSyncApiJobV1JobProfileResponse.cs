...
namespace EdGraph.Datasync.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataSyncApi.Job.V1.JobProfileResponse")]
    public partial class DataSyncApiJobV1JobProfileResponse : IEquatable<DataSyncApiJobV1JobProfileResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiJobV1JobProfileResponse" /> class.
        /// </summary>
        ...
        public DataSyncApiJobV1JobProfileResponse(string tenantId = default(string), string jobId = default(string), string name = default(string), string jobTypeId = default(string), string jobTypeName = default(string), string sourceConnectionId = default(string), string destinationConnectionId = default(string), string profileId = default(string), string profileName = default(string), string applicationId = default(string), int jobPoints = default(int), DataSyncApiJobV1DataRefreshType? dataRefreshType = default(DataSyncApiJobV1DataRefreshType?), string dataRefreshSpecificDate = default(string), int maxApiFailure = default(int), int maxApiRetry = default(int), string jobCompleteCallbackUrl = default(string), DataSyncApiJobV1Schedule schedule = default(DataSyncApiJobV1Schedule), DataSyncApiJobV1JobStatus? jobStatus = default(DataSyncApiJobV1JobStatus?), string jobExecutionId = default(string), DataSyncApiJobV1JobExecutionStatus? jobExecutionStatus = default(DataSyncApiJobV1JobExecutionStatus?), string jobExecutionStartDateTime = default(string), string jobExecutionEndDateTime = default(string), string createdBy = default(string), string createdDateTime = default(string), string lastModifiedBy = default(string), string lastModifiedDateTime = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiJobV1JobProfileResponse {\n");
        ...
        {
            return this.Equals(input as DataSyncApiJobV1JobProfileResponse);
        }

        /// <summary>
        /// Returns true if DataSyncApiJobV1JobProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiJobV1JobProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiJobV1JobProfileResponse input)
        {
            if (input == null)
            {
                return false;
